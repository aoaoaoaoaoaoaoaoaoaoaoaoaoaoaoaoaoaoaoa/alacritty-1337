...
Run the release version of alacritty-1337 while recording call stacks. After the
alacritty-1337 process exits, a flamegraph will be generated and it's URI printed
